            ...
            <div class="col-lg-3">
                <div class="sidebar">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url('/admin') ?>">Barang</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-lg-9">
                ...
                <div class="container">
                    <div class="card ;"style="margin-right:-80px">
                        <h5 class="card-header">Selamat Datang di Portal Recycle Earth User</h5>
                        <div class="card-body">
                            <a href="<?= site_url('admin/isi_user') ?>" class="btn btn-primary">+ Isi User Baru</a>
                        </div>
                    </div>
                </div>
                <div class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning btn-sm" >
                                                    <a class="text-white"
                                                        href="<?= site_url('admin/edit_user/' . $post['id']) ?>">Edit</a>
                                                </button>
                                                <button class="btn btn-danger btn-sm">
                                                    <a class="text-white"
                                                        href="<?= site_url('admin/delete_user/' . $post['id']) ?>">Delete</a>
                                                </button>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
